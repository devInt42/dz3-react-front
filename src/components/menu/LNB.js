          ...
          return (
            menu.menuDepth == 0 && (
              <div id={menu.menuSeq} key={menu.menuSeq}
                ...
                <span>
                  {menu.menuIcons ? <img src={process.env.PUBLIC_URL + menu.menuIcons} className={style.lnb_showDetailIcon} style={{ width: "35px", height: "35px", backgroundColor: "aliceblue"}} /> : <></>}
                </span>
                {menuVisible && <>
