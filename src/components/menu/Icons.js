                            ...
                            <Table sx={{ minWidth: 550 }} aria-label="simple table">
                                ...
                                <TableBody style={{backgroundColor: "rgba(154, 161, 161, 0.423)"}}>
                                    <TableRow >
                                        ...
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon4.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon4.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon5.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon5.png")}/></TableCell>
                                     ...
                                     <TableRow>
                                        ...
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon10.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon10.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon11.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon11.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon12.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon12.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon14.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon14.png")}/></TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon20.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon20.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon21.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon21.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon22.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon22.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon23.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon23.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/icon24.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/icon24.png")}/></TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/calculator.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/calculator.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/calendar.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/calendar.png")}/></TableCell>
                                        <TableCell onClick={()=> {handleClose();}}><img src={process.env.PUBLIC_URL + "/menuIcons/email.png"} className={styles.icons} onClick={()=> props.setImgFile("/menuIcons/email.png")}/></TableCell>
