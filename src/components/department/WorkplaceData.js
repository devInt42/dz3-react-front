...
const WorkplaceData = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}/department/list/workplace`)
            ...
            <div key={workplacedata.workplaceSeq}>
              {workplacedata.companySeq === props.companySeq && (
                <div className="workplacelist">
                  <div
                    className={
                      focusWorkplace === workplacedata.workplaceSeq
                        ? "active-item"
                        : "workplace-item"
                    }
                    onClick={() => {
                      workplaceIsOpen.includes(workplacedata.workplaceSeq)
                        ? setWorkplaceIsOpen(
                            workplaceIsOpen.filter(
                              (workplace) =>
                                workplace !== workplacedata.workplaceSeq
                            )
                          )
                        : setWorkplaceIsOpen([
                            ...workplaceIsOpen,
                            workplacedata.workplaceSeq,
                          ]);
                  ...
                  >
                    ...
                    {toggleIcon.includes(workplacedata.workplaceSeq) ? (
                      <HiChevronDown />
                    ) : (
                      <HiChevronUp />
                    )}
                  ...
                  {workplaceIsOpen.includes(workplacedata.workplaceSeq) && (
                    <DepartmentData
                      workplaceSeq={workplacedata.workplaceSeq}
                      ...
                      setFocusWorkplace={setFocusWorkplace}
