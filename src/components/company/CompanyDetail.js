...
const CompanyDetail = ((props) => {
  ...
  useEffect(() => {
    ...
    props.companySeq &&
      axios
        .get(`${baseUrl}/company/info/${props.companySeq}`)
      ...
      <div className="infoheader">
        ...
        <div>
          ...
          <button
            ...
            onClick={() => props.setDetailFlag(false)}
          >
            {" "}
            <TfiClose />
          </button>
            ...
            <td className="company-table-content">
              <div className="company-table-td-twocontent">
                ...
                >
                  ...
                  <option
                    value="법인"
                    selected={pcBuisness === "법인" ? true : false}
                  >
                    법인
                  </option>
                  <option
                    value="개인"
                    selected={pcBuisness === "개인" ? true : false}
                  >
                    개인
                  </option>
                </select>
            ...
            <td className="company-table-content">
              <div className="company-table-td-twocontent">
                ...
                >
                  ...
                  <option
                    value="내국인"
                    selected={companyForeigner === "내국인" ? true : false}
                  >
                    내국인
                  </option>
                  <option
                    value="외국인"
                    selected={companyForeigner === "외국인" ? true : false}
                  >
                    외국인
                  </option>
                </select>
